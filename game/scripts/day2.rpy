label day2Petr:
    ...
    if not persistent.coll5_unlocked:
...
label day2Petr_2:
    ...
    "{italic}Я погодилася - і ми одразу пішли до озера. Я трішки хвилювалася, бо не хотіла намочити одяг і... і не хотіла, щоб вона побачила, як я заглядаюся на її тіло. Дивне відчуття...{/italic}"
