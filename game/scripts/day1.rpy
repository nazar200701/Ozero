...
label day1:
    ...
    "Таємнича дівчина" "*Хмпф* Вельми вдячна за допомогу!"
    liza "Але ж я нічого не зробила..."
    "Таємнича дівчина" "А то я не помітила..."
    "..."
    ...
    if persistent.collectibles_count >= 4 and persistent.pazzle_was==False:
        ...
        jump day1_2
label day1_2:
    "Таємнича дівчина" "Ой, бачу на серці смуток? Невже коханий образив?"
    "Таємнича дівчина" "Що ж скоїлось, що ти забігла так далеко від дому?"
    pause 1.5
    "Таємнича дівчина" "Аж сюди... "
    extend "До мене... "
    extend "На моє озеро..."
    ...
    "Таємнича дівчина" "Така красива… Така беззахисна."
    pause 1.5
    "Таємнича дівчина" "Така сумна… Така стурбована."

    "..."
    "Таємнича дівчина" "Не бійся мене, мила дівчинко, я ж не така страшна..."
    "Таємнича дівчина" "Відповіси на моє питання, любонько, та й дізнаємося доленьку твою..."
    ...
    "Таємнича дівчина" "Полин чи петрушка?"
