...
label Petrushka_part2:
    ...
    "Таємнича дівчина" "То що в тебе сталося, серденько? Розповіси мені все, та, можливо, я тобі допоможу."
    ...
    pause 1.5
    "Таємнича дівчина" "Чого ж ти тоді…"
    hide liza
    hide poli
    ...
    "Таємнича дівчина" "Ой лишенько… Йди до мене, я тебе обійму, тобі стане краще..."
    ...
    "Таємнича дівчина" "Ну, що, стало краще?"
